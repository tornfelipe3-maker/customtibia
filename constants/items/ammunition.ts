...
export const AMMUNITION_LIST: Item[] = [
  ...
  { id: 'arrow', name: 'Arrow', type: 'equipment', slot: EquipmentSlot.AMMO, attack: 6, price: 3, sellPrice: 1, soldTo: [NpcType.TRADER], description: 'Munição básica para Arcos.', ammoType: 'arrow', image: `${IMG_BASE}Arrow.gif` },
  
  // TIER 2 - Bolt (RP ATK 11)
  { id: 'bolt', name: 'Bolt', type: 'equipment', slot: EquipmentSlot.AMMO, attack: 11, price: 4, sellPrice: 1, soldTo: [NpcType.TRADER], description: 'Munição para Bestas (Tier 2).', ammoType: 'bolt', image: `${IMG_BASE}Bolt.gif` },
  
  // TIER 3 - Sniper Arrow (RP ATK 19)
  { id: 'sniper_arrow', name: 'Sniper Arrow', type: 'equipment', slot: EquipmentSlot.AMMO, attack: 19, price: 10, sellPrice: 3, soldTo: [NpcType.TRADER], description: 'Flecha precisa (Tier 3).', ammoType: 'arrow', image: `${IMG_BASE}Sniper_Arrow.gif` },

  // TIER 4 - Onyx Arrow (RP ATK 28)
  { id: 'onyx_arrow', name: 'Onyx Arrow', type: 'equipment', slot: EquipmentSlot.AMMO, attack: 28, price: 20, sellPrice: 5, soldTo: [NpcType.TRADER], description: 'Flecha de ônix (Tier 4).', ammoType: 'arrow', image: `${IMG_BASE}Onyx_Arrow.gif` },

  // TIER 5 - Power Bolt (RP ATK 40)
  { id: 'power_bolt', name: 'Power Bolt', type: 'equipment', slot: EquipmentSlot.AMMO, attack: 40, price: 35, sellPrice: 10, soldTo: [NpcType.TRADER], description: 'Poderoso (Tier 5).', ammoType: 'bolt', image: `${IMG_BASE}Power_Bolt.gif` },
