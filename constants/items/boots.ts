...
export const BOOTS_LIST: Item[] = [
  ...
  // TIER 3
  { id: 'boh', name: 'Boots of Haste', type: 'equipment', slot: EquipmentSlot.FEET, armor: 2, price: 0, sellPrice: 30000, soldTo: [NpcType.BLUE_DJINN, NpcType.RASHID], description: 'Botas da velocidade (Tier 3).', image: `${IMG_BASE}Boots_of_Haste.gif`, requiredLevel: 20 },

  // TIER 4
  { id: 'knight_boots', name: 'Knight Boots', type: 'equipment', slot: EquipmentSlot.FEET, armor: 3, price: 0, sellPrice: 2500, soldTo: [NpcType.GREEN_DJINN, NpcType.RASHID], description: 'Botas de cavaleiro (Tier 4).', image: `${IMG_BASE}Knight_Boots.gif`, requiredLevel: 40 },
  ...
  // TIER 8
  { id: 'falcon_boots', name: 'Falcon Boots', type: 'equipment', slot: EquipmentSlot.FEET, armor: 7, price: 0, sellPrice: 150000, soldTo: [NpcType.RASHID], description: 'Botas do Falcão (Tier 8).', image: `${IMG_BASE}Falcon_Greaves.gif`, requiredLevel: 400 },
];
