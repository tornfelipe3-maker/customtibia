...
export const DISTANCE_LIST: Item[] = [
  ...
  { id: 'heavy_crossbow', name: 'Heavy Crossbow', type: 'equipment', slot: EquipmentSlot.HAND_RIGHT, attack: 1, defense: 0, price: 0, sellPrice: 25000, soldTo: [NpcType.GREEN_DJINN, NpcType.BLUE_DJINN, NpcType.RASHID], description: 'Besta pesada (Tier 5).', scalingStat: SkillType.DISTANCE, weaponType: 'crossbow', requiredVocation: [Vocation.PALADIN], image: `${IMG_BASE}Heavy_Crossbow.gif`, requiredLevel: 100 },
