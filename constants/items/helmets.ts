...
export const HELMETS_LIST: Item[] = [
  ...
  { id: 'plate_helmet', name: 'Plate Helmet', type: 'equipment', slot: EquipmentSlot.HEAD, armor: 2, price: 800, sellPrice: 15, soldTo: [NpcType.TRADER, NpcType.RASHID], description: 'Capacete de placas (Tier 2).', image: `${IMG_BASE}Plate_Helmet.gif`, requiredLevel: 8 },
