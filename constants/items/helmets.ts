...
export const HELMETS_LIST: Item[] = [
  ...
  { id: 'dragon_helmet', name: 'Dragon Helmet', type: 'equipment', slot: EquipmentSlot.HEAD, armor: 4, price: 0, sellPrice: 4000, soldTo: [NpcType.GREEN_DJINN], description: 'Capacete de dragão (Tier 4).', image: `${IMG_BASE}Dragon_Helmet.gif`, requiredLevel: 40 },
