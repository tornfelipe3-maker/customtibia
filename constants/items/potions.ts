...
export const POTION_LIST: Item[] = [
  ...
  { id: 'strong_mana_potion', name: 'Strong Mana Potion', type: 'potion', potionType: 'mana', restoreAmount: 150, price: 80, sellPrice: 8, soldTo: [NpcType.TRADER], description: 'Restores ~150 MP. (Lvl 50)', requiredLevel: 50, requiredVocation: [Vocation.PALADIN, Vocation.SORCERER, Vocation.DRUID], image: `${IMG_BASE}Strong_Mana_Potion.gif` },
