...
export const PRODUCTS_LIST: Item[] = [
  ...
  { id: 'violet_gem', name: 'Violet Gem', type: 'loot', price: 0, sellPrice: 12000, soldTo: [NpcType.TRADER, NpcType.YASIR], description: 'A highly valuable violet gem.', image: `${IMG_BASE}Violet_Gem.gif` },
  ...
  { id: 'white_pearl', name: 'White Pearl', type: 'loot', price: 0, sellPrice: 200, soldTo: [NpcType.TRADER, NpcType.YASIR], description: 'A pretty pearl.', image: `${IMG_BASE}White_Pearl.gif` },
  { id: 'black_pearl', name: 'Black Pearl', type: 'loot', price: 0, sellPrice: 500, soldTo: [NpcType.TRADER, NpcType.YASIR], description: 'A rare black pearl.', image: `${IMG_BASE}Black_Pearl.gif` },
  { id: 'giant_shimmering_pearl', name: 'Giant Shimmering Pearl', type: 'loot', price: 0, sellPrice: 4000, soldTo: [NpcType.TRADER, NpcType.YASIR], description: 'A giant pearl.', image: `${IMG_BASE}Giant_Shimmering_Pearl.gif` },
  ...
  { id: 'gold_ingot', name: 'Gold Ingot', type: 'loot', price: 0, sellPrice: 7500, soldTo: [NpcType.RASHID, NpcType.YASIR], description: 'Solid gold.', image: `${IMG_BASE}Gold_Ingot.gif` },
  ...
  { id: 'spatial_warp_almanac', name: 'Spatial Warp Almanac', type: 'loot', price: 0, sellPrice: 10000, soldTo: [NpcType.RASHID, NpcType.YASIR], description: 'A rare book from Oberon.', image: `${IMG_BASE}Spatial_Warp_Almanac.gif` },
];
