...
export const SHIELDS_LIST: Item[] = [
  ...
  { id: 'dragon_shield', name: 'Dragon Shield', type: 'equipment', slot: EquipmentSlot.HAND_LEFT, defense: 31, price: 5000, sellPrice: 4000, soldTo: [NpcType.GREEN_DJINN], description: 'Escudo de dragão (Tier 4).', image: `${IMG_BASE}Dragon_Shield.gif`, requiredLevel: 40 },

  // TIER 5 (Lvl 100-200) -> Item Lvl 100
  { id: 'guardian_shield', name: 'Guardian Shield', type: 'equipment', slot: EquipmentSlot.HAND_LEFT, defense: 28, price: 3000, sellPrice: 1500, soldTo: [NpcType.BLUE_DJINN], description: 'Escudo guardião (Tier 5).', image: `${IMG_BASE}Guardian_Shield.gif`, requiredLevel: 100 },
