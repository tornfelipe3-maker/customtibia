...
export const WANDS_LIST: Item[] = [
  ...
  // TIER 4 (Lvl 40-60)
  { id: 'wand_inferno', name: 'Wand of Inferno', type: 'equipment', slot: EquipmentSlot.HAND_RIGHT, attack: 48, defense: 0, price: 80000, sellPrice: 7500, soldTo: [NpcType.GREEN_DJINN, NpcType.BLUE_DJINN, NpcType.RASHID], description: 'Fogo puro (Tier 4).', scalingStat: SkillType.MAGIC, damageType: DamageType.FIRE, requiredVocation: [Vocation.SORCERER], manaCost: 13, image: `${IMG_BASE}Wand_of_Inferno.gif`, requiredLevel: 40 },
  ...
  // TIER 4 (Lvl 40-60)
  { id: 'hailstorm_rod', name: 'Hailstorm Rod', type: 'equipment', slot: EquipmentSlot.HAND_RIGHT, attack: 48, defense: 0, price: 80000, sellPrice: 7500, soldTo: [NpcType.GREEN_DJINN, NpcType.BLUE_DJINN, NpcType.RASHID], description: 'Tempestade de gelo (Tier 4).', scalingStat: SkillType.MAGIC, damageType: DamageType.ICE, requiredVocation: [Vocation.DRUID], manaCost: 13, image: `${IMG_BASE}Hailstorm_Rod.gif`, requiredLevel: 40 },
