...
export const MONSTERS: Monster[] = [
    ...
    // ========================================================================
    { 
        id: 'wolf', name: 'Wolf', level: 9, hp: 120, maxHp: 120, exp: 40, minGold: 10, maxGold: 20, damageMin: 8, damageMax: 20, attackSpeedMs: 2000, image: `${IMG_BASE}Wolf.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'ghoul', name: 'Ghoul', level: 20, hp: 350, maxHp: 350, exp: 160, minGold: 35, maxGold: 80, damageMin: 30, damageMax: 60, attackSpeedMs: 2000, image: `${IMG_BASE}Ghoul.gif`, 
        lootTable: [
    ...
    { 
        id: 'orc_berserker', name: 'Orc Berserker', level: 25, hp: 500, maxHp: 500, exp: 240, minGold: 50, maxGold: 100, damageMin: 50, damageMax: 100, attackSpeedMs: 2000, image: `${IMG_BASE}Orc_Berserker.gif`,
        lootTable: [
    ...
    { 
        id: 'cyclops', name: 'Cyclops', level: 35, hp: 800, maxHp: 800, exp: 400, minGold: 80, maxGold: 160, damageMin: 70, damageMax: 130, attackSpeedMs: 2000, image: `${IMG_BASE}Cyclops.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'dragon_hatchling', name: 'Dragon Hatchling', level: 40, hp: 1200, maxHp: 1200, exp: 700, minGold: 90, maxGold: 180, damageMin: 90, damageMax: 160, attackSpeedMs: 2000, image: `${IMG_BASE}Dragon_Hatchling.gif`,
        lootTable: [
    ...
    { 
        id: 'giant_spider', name: 'Giant Spider', level: 50, hp: 2000, maxHp: 2000, exp: 1600, minGold: 140, maxGold: 300, damageMin: 140, damageMax: 240, attackSpeedMs: 2000, image: `${IMG_BASE}Giant_Spider.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'hero', name: 'Hero', level: 100, hp: 4500, maxHp: 4500, exp: 3500, minGold: 220, maxGold: 550, damageMin: 220, damageMax: 350, attackSpeedMs: 2000, image: `${IMG_BASE}Hero.gif`,
        lootTable: [
    ...
    { 
        id: 'vampire_lord', name: 'Vampire Lord', level: 120, hp: 6000, maxHp: 6000, exp: 5000, minGold: 300, maxGold: 700, damageMin: 280, damageMax: 450, attackSpeedMs: 2000, image: `${IMG_BASE}Vampire_Lord.gif`,
        lootTable: [
    ...
    { 
        id: 'dragon_lord', name: 'Dragon Lord', level: 160, hp: 8000, maxHp: 8000, exp: 7500, minGold: 400, maxGold: 900, damageMin: 350, damageMax: 600, attackSpeedMs: 2000, elements: { fire: 1.0, earth: 0.2 }, image: `${IMG_BASE}Dragon_Lord.gif`,
        lootTable: [
    ...
    { 
        id: 'behemoth', name: 'Behemoth', level: 180, hp: 11000, maxHp: 11000, exp: 10000, minGold: 500, maxGold: 1000, damageMin: 450, damageMax: 800, attackSpeedMs: 2000, image: `${IMG_BASE}Behemoth.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'hellhound', name: 'Hellhound', level: 300, hp: 30000, maxHp: 30000, exp: 30000, minGold: 1800, maxGold: 3000, damageMin: 1000, damageMax: 1600, attackSpeedMs: 2000, elements: { fire: 0, ice: 1.2 }, image: `${IMG_BASE}Hellhound.gif`,
        lootTable: [
    ...
    { 
        id: 'plaguesmith', name: 'Plaguesmith', level: 380, hp: 40000, maxHp: 40000, exp: 40000, minGold: 2200, maxGold: 3500, damageMin: 1200, damageMax: 1800, attackSpeedMs: 2000, elements: { earth: 0, fire: 1.1 }, image: `${IMG_BASE}Plaguesmith.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'dawnfire_asura', name: 'Dawnfire Asura', level: 400, hp: 50000, maxHp: 50000, exp: 50000, minGold: 3000, maxGold: 5000, damageMin: 1500, damageMax: 2200, attackSpeedMs: 2000, elements: { fire: 0.5, death: 0.8, ice: 1.1 }, image: `${IMG_BASE}Dawnfire_Asura.gif`,
        lootTable: [
