...
export const MONSTERS: Monster[] = [
    // ========================================================================
    // TIER 1: LEVEL 1-8
    // Nerfed Drop Rates to balance early game economy.
    // ========================================================================
    { 
        id: 'rat', name: 'Rat', level: 1, hp: 35, maxHp: 35, exp: 5, minGold: 2, maxGold: 5, damageMin: 0, damageMax: 3, attackSpeedMs: 2000, image: `${IMG_BASE}Rat.gif`, 
        lootTable: [
            { itemId: 'cheese', chance: 0.4, maxAmount: 1 },
            { itemId: 'rat_tail', chance: 0.25, maxAmount: 1 }, 
            { itemId: 'coat', chance: 0.05, maxAmount: 1 },     
            { itemId: 'leather_boots', chance: 0.03, maxAmount: 1 }, 
            { itemId: 'wooden_shield', chance: 0.04, maxAmount: 1 }, 
            { itemId: 'dagger', chance: 0.05, maxAmount: 1 },        
            { itemId: 'small_amethyst', chance: 0.001, maxAmount: 1 } 
        ] 
    },
    { 
        id: 'troll', name: 'Troll', level: 5, hp: 90, maxHp: 90, exp: 25, minGold: 5, maxGold: 12, damageMin: 5, damageMax: 12, attackSpeedMs: 2000, image: `${IMG_BASE}Troll.gif`,
        lootTable: [
            { itemId: 'meat', chance: 0.3, maxAmount: 1 },
            { itemId: 'troll_hair', chance: 0.20, maxAmount: 1 }, 
            { itemId: 'brass_helmet', chance: 0.02, maxAmount: 1 }, 
            { itemId: 'brass_armor', chance: 0.01, maxAmount: 1 },  
            { itemId: 'brass_legs', chance: 0.01, maxAmount: 1 },   
            { itemId: 'hand_axe', chance: 0.05, maxAmount: 1 }, 
            { itemId: 'spear', chance: 0.10, maxAmount: 1 },        // Reduced chance (0.15->0.10) and qty (2->1)
            { itemId: 'silver_amulet', chance: 0.005, maxAmount: 1 }
        ] 
    },

    // ========================================================================
    // TIER 2: LEVEL 9-20
    // Moderate drops. Transition to Plate should be harder.
    // ========================================================================
    { 
        id: 'wolf', name: 'Wolf', level: 9, hp: 120, maxHp: 120, exp: 40, minGold: 5, maxGold: 15, damageMin: 8, damageMax: 20, attackSpeedMs: 1800, image: `${IMG_BASE}Wolf.gif`,
        lootTable: [
            { itemId: 'meat', chance: 0.4, maxAmount: 2 },
            { itemId: 'wolf_paw', chance: 0.15, maxAmount: 1 }, 
            { itemId: 'plate_shield', chance: 0.01, maxAmount: 1 }, 
            { itemId: 'short_sword', chance: 0.04, maxAmount: 1 }
        ] 
    },
    { 
        id: 'skeleton', name: 'Skeleton', level: 12, hp: 180, maxHp: 180, exp: 65, minGold: 10, maxGold: 25, damageMin: 15, damageMax: 30, attackSpeedMs: 2000, image: `${IMG_BASE}Skeleton.gif`,
        lootTable: [
            { itemId: 'bone', chance: 0.35, maxAmount: 2 }, 
            { itemId: 'plate_helmet', chance: 0.01, maxAmount: 1 }, 
            { itemId: 'plate_armor', chance: 0.005, maxAmount: 1 }, 
            { itemId: 'axe', chance: 0.03, maxAmount: 1 },
            { itemId: 'bone_club', chance: 0.05, maxAmount: 1 },
            { itemId: 'small_topaz', chance: 0.005, maxAmount: 1 }
        ] 
    },
    { 
        id: 'orc', name: 'Orc', level: 15, hp: 220, maxHp: 220, exp: 90, minGold: 15, maxGold: 35, damageMin: 20, damageMax: 40, attackSpeedMs: 2000, image: `${IMG_BASE}Orc.gif`, 
        lootTable: [
            { itemId: 'orc_tooth', chance: 0.20, maxAmount: 1 }, 
            { itemId: 'plate_legs', chance: 0.01, maxAmount: 1 }, 
            { itemId: 'short_sword', chance: 0.05, maxAmount: 1 }, 
            { itemId: 'health_potion', chance: 0.08, maxAmount: 1 } 
        ] 
    },
    ...
    { 
        ...
        lootTable: [
            { itemId: 'rotten_piece_of_cloth', chance: 0.15, maxAmount: 1 }, 
            { itemId: 'ghoul_snack', chance: 0.25, maxAmount: 1 }, 
            { itemId: 'crown_helmet', chance: 0.002, maxAmount: 1 }, 
            { itemId: 'life_ring', chance: 0.005, maxAmount: 1 }
        ] 
    },
    { 
        ...
        lootTable: [
            { itemId: 'orc_leather', chance: 0.25, maxAmount: 1 },
            { itemId: 'crown_legs', chance: 0.003, maxAmount: 1 },
            { itemId: 'crimson_sword', chance: 0.02, maxAmount: 1 }, 
            { itemId: 'orcish_axe', chance: 0.02, maxAmount: 1 }, 
            { itemId: 'health_potion', chance: 0.12, maxAmount: 2 } 
        ] 
    },
    { 
        ...
        lootTable: [
            { itemId: 'minotaur_leather', chance: 0.30, maxAmount: 1 },
            { itemId: 'crown_armor', chance: 0.002, maxAmount: 1 }, 
            { itemId: 'crown_shield', chance: 0.005, maxAmount: 1 },
            { itemId: 'wand_draconia', chance: 0.01, maxAmount: 1 }, 
    ...
    { 
        ...
        lootTable: [
            { itemId: 'cyclops_toe', chance: 0.4, maxAmount: 1 }, 
    ...
    { 
        ...
        lootTable: [
            ...
            { itemId: 'small_emerald', chance: 0.08, maxAmount: 1 }, 
    ...
    { 
        ...
        lootTable: [
            ...
            { itemId: 'dragon_legs', chance: 0.001, maxAmount: 1 }, 
    ...
    { 
        ...
        lootTable: [
            { itemId: 'spider_silk', chance: 0.08, maxAmount: 1 }, 
    ...
    { 
        ...
        lootTable: [
            ...
            { itemId: 'dsm', chance: 0.001, maxAmount: 1 },       
    ...
    { 
        ...
        lootTable: [
            ...
            { itemId: 'dragon_claw_common', chance: 0.05, maxAmount: 1 }, 
            { itemId: 'mpa', chance: 0.0005, maxAmount: 1 },              
            { itemId: 'dsm', chance: 0.005, maxAmount: 1 },
            { itemId: 'royal_spear', chance: 0.2, maxAmount: 3 }, // Reduced chance and qty
            { itemId: 'great_health_potion', chance: 0.2, maxAmount: 2 }
        ] 
    },
    { 
    ...
    { 
        ...
        lootTable: [
            ...
            { itemId: 'ruby', chance: 0.15, maxAmount: 1 },         
    ...
    { 
        ...
        lootTable: [
            { itemId: 'demon_horn', chance: 0.35, maxAmount: 2 },    
    ...
    { 
        ...
        lootTable: [
            ...
            { itemId: 'steel_boots', chance: 0.15, maxAmount: 1 } 
        ] 
    },
