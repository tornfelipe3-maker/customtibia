...
export const MONSTERS: Monster[] = [
    ...
    // ========================================================================
    { 
        id: 'rat', name: 'Rat', level: 1, hp: 35, maxHp: 35, exp: 5, minGold: 3, maxGold: 8, damageMin: 0, damageMax: 3, attackSpeedMs: 1000, image: `${IMG_BASE}Rat.gif`, 
        lootTable: [
    ...
    { 
        id: 'troll', name: 'Troll', level: 5, hp: 90, maxHp: 90, exp: 25, minGold: 8, maxGold: 18, damageMin: 5, damageMax: 12, attackSpeedMs: 1000, image: `${IMG_BASE}Troll.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'wolf', name: 'Wolf', level: 9, hp: 120, maxHp: 120, exp: 40, minGold: 10, maxGold: 20, damageMin: 8, damageMax: 20, attackSpeedMs: 1000, image: `${IMG_BASE}Wolf.gif`,
        lootTable: [
    ...
    { 
        id: 'skeleton', name: 'Skeleton', level: 12, hp: 180, maxHp: 180, exp: 65, minGold: 15, maxGold: 30, damageMin: 15, damageMax: 30, attackSpeedMs: 1000, image: `${IMG_BASE}Skeleton.gif`,
        lootTable: [
    ...
    { 
        id: 'orc', name: 'Orc', level: 15, hp: 220, maxHp: 220, exp: 90, minGold: 20, maxGold: 40, damageMin: 20, damageMax: 40, attackSpeedMs: 1000, image: `${IMG_BASE}Orc.gif`, 
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'ghoul', name: 'Ghoul', level: 20, hp: 350, maxHp: 350, exp: 160, minGold: 35, maxGold: 80, damageMin: 30, damageMax: 60, attackSpeedMs: 1000, image: `${IMG_BASE}Ghoul.gif`, 
        lootTable: [
    ...
    { 
        id: 'orc_berserker', name: 'Orc Berserker', level: 25, hp: 500, maxHp: 500, exp: 240, minGold: 50, maxGold: 100, damageMin: 50, damageMax: 100, attackSpeedMs: 1000, image: `${IMG_BASE}Orc_Berserker.gif`,
        lootTable: [
    ...
    { 
        id: 'minotaur_guard', name: 'Minotaur Guard', level: 30, hp: 650, maxHp: 650, exp: 320, minGold: 60, maxGold: 120, damageMin: 60, damageMax: 110, attackSpeedMs: 1000, image: `${IMG_BASE}Minotaur_Guard.gif`,
        lootTable: [
    ...
    { 
        id: 'cyclops', name: 'Cyclops', level: 35, hp: 800, maxHp: 800, exp: 400, minGold: 80, maxGold: 160, damageMin: 70, damageMax: 130, attackSpeedMs: 1000, image: `${IMG_BASE}Cyclops.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'dragon_hatchling', name: 'Dragon Hatchling', level: 40, hp: 1200, maxHp: 1200, exp: 700, minGold: 90, maxGold: 180, damageMin: 90, damageMax: 160, attackSpeedMs: 1000, image: `${IMG_BASE}Dragon_Hatchling.gif`,
        lootTable: [
    ...
    { 
        id: 'necromancer', name: 'Necromancer', level: 45, hp: 1500, maxHp: 1500, exp: 1000, minGold: 100, maxGold: 220, damageMin: 100, damageMax: 180, attackSpeedMs: 1000, elements: { holy: 1.2 }, image: `${IMG_BASE}Necromancer.gif`,
        lootTable: [
    ...
    { 
        id: 'giant_spider', name: 'Giant Spider', level: 50, hp: 2000, maxHp: 2000, exp: 1600, minGold: 140, maxGold: 300, damageMin: 140, damageMax: 240, attackSpeedMs: 1000, image: `${IMG_BASE}Giant_Spider.gif`,
        lootTable: [
    ...
    { 
        id: 'dragon', name: 'Dragon', level: 60, hp: 3200, maxHp: 3200, exp: 2100, minGold: 180, maxGold: 400, damageMin: 180, damageMax: 280, attackSpeedMs: 1000, elements: { fire: 1.0, earth: 0.2 }, image: `${IMG_BASE}Dragon.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'hero', name: 'Hero', level: 100, hp: 4500, maxHp: 4500, exp: 3500, minGold: 220, maxGold: 550, damageMin: 220, damageMax: 350, attackSpeedMs: 1000, image: `${IMG_BASE}Hero.gif`,
        lootTable: [
    ...
    { 
        id: 'vampire_lord', name: 'Vampire Lord', level: 120, hp: 6000, maxHp: 6000, exp: 5000, minGold: 300, maxGold: 700, damageMin: 280, damageMax: 450, attackSpeedMs: 1000, image: `${IMG_BASE}Vampire_Lord.gif`,
        lootTable: [
    ...
    { 
        id: 'dragon_lord', name: 'Dragon Lord', level: 160, hp: 8000, maxHp: 8000, exp: 7500, minGold: 400, maxGold: 900, damageMin: 350, damageMax: 600, attackSpeedMs: 1000, elements: { fire: 1.0, earth: 0.2 }, image: `${IMG_BASE}Dragon_Lord.gif`,
        lootTable: [
    ...
    { 
        id: 'behemoth', name: 'Behemoth', level: 180, hp: 11000, maxHp: 11000, exp: 10000, minGold: 500, maxGold: 1000, damageMin: 450, damageMax: 800, attackSpeedMs: 1000, image: `${IMG_BASE}Behemoth.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'warlock', name: 'Warlock', level: 200, hp: 14000, maxHp: 14000, exp: 14000, minGold: 700, maxGold: 1400, damageMin: 550, damageMax: 900, attackSpeedMs: 1000, image: `${IMG_BASE}Warlock.gif`,
        lootTable: [
    ...
    { 
        id: 'demon', name: 'Demon', level: 280, hp: 22000, maxHp: 22000, exp: 22000, minGold: 1200, maxGold: 2500, damageMin: 700, damageMax: 1200, attackSpeedMs: 1000, elements: { fire: 1.0, energy: 0.5, ice: 1.2 }, image: `${IMG_BASE}Demon.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'hellhound', name: 'Hellhound', level: 300, hp: 30000, maxHp: 30000, exp: 30000, minGold: 1800, maxGold: 3000, damageMin: 1000, damageMax: 1600, attackSpeedMs: 1000, elements: { fire: 0, ice: 1.2 }, image: `${IMG_BASE}Hellhound.gif`,
        lootTable: [
    ...
    { 
        id: 'plaguesmith', name: 'Plaguesmith', level: 380, hp: 40000, maxHp: 40000, exp: 40000, minGold: 2200, maxGold: 3500, damageMin: 1200, damageMax: 1800, attackSpeedMs: 1000, elements: { earth: 0, fire: 1.1 }, image: `${IMG_BASE}Plaguesmith.gif`,
        lootTable: [
    ...
    // ========================================================================
    { 
        id: 'dawnfire_asura', name: 'Dawnfire Asura', level: 400, hp: 50000, maxHp: 50000, exp: 50000, minGold: 3000, maxGold: 5000, damageMin: 1500, damageMax: 2200, attackSpeedMs: 1000, elements: { fire: 0.5, death: 0.8, ice: 1.1 }, image: `${IMG_BASE}Dawnfire_Asura.gif`,
        lootTable: [
    ...
    { 
        id: 'hellgorak', name: 'Hellgorak', level: 600, hp: 75000, maxHp: 75000, exp: 80000, minGold: 500, maxGold: 8000, damageMin: 2000, damageMax: 3500, attackSpeedMs: 1000, elements: { physical: 0.6, ice: 1.05 }, image: `${IMG_BASE}Hellgorak.gif`,
        lootTable: [
